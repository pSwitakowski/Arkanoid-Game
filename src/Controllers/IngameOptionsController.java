...
/**
 * Class responsible for handling in-game options menu.
 */
public class IngameOptionsController implements Initializable {
    ...
    /**
     * Button responsible for resuming the game.
     */
    @FXML
